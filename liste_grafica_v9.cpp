...
char meniuSimpla()
{
    ...
    cout<<"\t\tOperatii cu lista simplu inlantuita\n";
    cout<<"a = adauga la inceput | z = adauga la final | x = suma listei | ";
    cout<<"t = afisare | e = stergere pozitie | g = golire | s = stop\n";
...
char meniuDubla()
{
    char tasta;
    cout<<"\n___________________________________________________________________________________________________\n";
    cout<<"\t\tOperatii cu lista dublu inlantuita\n";
    cout<<"a = adauga in fata | z = adauga in spate | e = eliminare curent ";
    cout<<"| t = afisare\ng = golire | c = creare aleatorie | s = stop\n";
    cout<<"___________________________________________________________________________________________________\n";
    cout<<"Comanda dvs: ";
    cin>>tasta;
    return tasta;
...
char meniuCoada()
{
    char tasta;
    cout<<"\n___________________________________________________________________________________________________\n";
    cout<<"\t\tOperatii cu o coada\n";
    cout<<"i = introdu element | e = eliminare ";
    cout<<"| t = afisare | g = golire | s = stop\n";
    cout<<"___________________________________________________________________________________________________\n";
    cout<<"Comanda dvs: ";
    cin>>tasta;
...
char meniuInit()
{
    char tasta;
    cout<<"\n___________________________________________________________________________________________________\n";
    cout << "\t\tCu ce tip de lista ati dori sa lucrati?\n";
    cout << "c = coada | s = stiva | l = lista inlantuita | d = lista dublu-inlantuita\n";
    cout<<"___________________________________________________________________________________________________\n";
    cout << "Comanda dvs: ";
    cin>>tasta;
    return tasta;
...
void deseneazaMeniulInitial()
{
    ...
    {
        B_init[i].D.SS.x=(GetSystemMetrics(SM_CXSCREEN)/2)-150;
        B_init[i].D.DJ.x=(GetSystemMetrics(SM_CXSCREEN)/2)+150;;
...
void deseneazaStiva(stiva S)
{
    ...
    else
    {
        ...
        while(p!=NULL)
        {
            ...
            {
                setcolor(RED);
                rectangle(width/2-width/8,height/10*9-100*(S.nrElemente - nr)-25,width/2+width/8,height/10*9-100*(S.nrElemente - nr)+25);
                setcolor(WHITE);
            }
            else
                rectangle(width/2-width/8,height/10*9-100*(S.nrElemente - nr)-25,width/2+width/8,height/10*9-100*(S.nrElemente - nr)+25);
            settextstyle(EUROPEAN_FONT,0, 2);
            outtextxy(width/2,height/10*9-100*(S.nrElemente - nr),valoare);
            p=p->urm;
            nr++;
            settextstyle(EUROPEAN_FONT, 0, 2);
        }
